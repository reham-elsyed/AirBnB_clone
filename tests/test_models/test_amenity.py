...
class TestAmenity_instantiation(unittest.TestCase):
    ...
    def test_two_amenites_differnt_updated_at(self):
        am1 = Amenity()
        sleep(0.05)
        am2 = Amenity()
    ...
    def test_instantiaton_with_kwargs(self):
...
class TestAmenity_save(unittest.TestCase):
    """Unittest test save method of Amenity class."""
...
class TestAmenity_to_dict(unittest.TestCase):
    """Unittest test to_dict method of  Amenity class."""
