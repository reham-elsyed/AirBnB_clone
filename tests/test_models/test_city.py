...
class TestCity_instntiation(unittest.TestCase):
    ...
    def test_name_is_publc_class_attr(self):
        cy = City()
...
class TestCty_to_dict(unittest.TestCase):
    """Unittests for testing to_dict method of the City class."""

    def test_to_dict_type(self):
        self.assertTrue(dict, type(City().to_dict()))

    def test_to_dict_contain_corrct_key(self):
        cty = City()
    ...
    def test_to_dict_contains_add_attr(self):
        cty = City()
    ...
    def test_contrst_to_dict_dict(self):
        cty = City()
